...
namespace NgolaTur.Controllers
{
    public class ProvinciaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeProvincia,EstadoProvincia")] Provincia provincia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeProvincia,EstadoProvincia")] Provincia provincia)
        {
            if (id != provincia.Id)
            {
                return NotFound();
